...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware('banque')->group(function () {
        ...
        Route::delete('/bank/poches/{id}/archive', [pocheController::class, 'archivePoche'])->name('poches.archive');
        ...
        Route::get('/bank/cautions/{id}/facture', [CautionController::class, 'facture']);

        Route::get('/bank/donneurs', [donneurController::class, 'index']);
        Route::get('/bank/donneurs/{id}', [donneurController::class, 'show']);
        Route::get( '/bank/partenaires',[PartenaireController::class, 'stocksPartenaires']);
